...
public class BigSmall {
	...
	/*
	 * this method is responsible for luanching browser and  landing at home page of website.
	 * 
	 * WebDriverHelper class has a launchingBrowser() method which will launch the browser.
	 * 
	...
	/*
	 * this method is responsible for testing sign in feature by sending username and password to login form.
	 * 
	 * SignInPage class contains method to return webElement of sign Page.
	 * 
...
//		}	
	...
	/*
	 * this method is responsible for test persionalized Gift Menu
	 * 
	 * persionalizedGiftPage class contains method to return webElements going to use in persionalized Gift Menu feature .
	 * persionalizedGiftPageLocators contains locators of these webElement
	 * 
	 * Assertion :- To cross check that product is selected on not
	 */
	@Test(priority = 3)
	...
	/*
	 * this method is responsible for test  Search  Product Feature 
	 * 
	 * RetreiveExcelData class has a method getdata for getting product name, has to be search
	 * 
	 * SearchBoxPage class contains method to return webElements going to use in search product feature .
	 *  SearchBoxPageLocators contains locators of these webElement
	 * 
	 * Assertion :- To cross check that wheather searched product list is appeared or not
	 */
	@Test(priority = 4)
	...
	/*
	 * this method is responsible for test Christmas Gift Menu Gift Menu
	 * 
	 * ChristmasGiftPage class contains method to return webElements, going to use in Christmas Gift Menu feature TESTING.
	 * ChristmasGiftPageLocators contains locators of these webElement
	 * 
	 * We will get list of products out of which, has to select first product and add it in card
	 * 
	 * Assertion :- To cross check that wheather product is added in wishlist on not
	 */
	@Test(priority = 5)
...
//		 log.info("pop up not appeared"); }
	...
	/*
	 * this method is responsible for test ShopByCategory Menu
	 * 
	 * ShopByCatagoryPage class contains method to return webElements, going to use in Christmas Gift Menu feature TESTING.
	 * ShopByCatagoryPageLocators contains locators of these webElement
	 * 
	 * We will get list of products out of which, has to select one product and add it in wishList.
	 * 
	 * Assertion :- To cross check that whether product is added in wisLlist on not
	 */
	@Test(priority = 6)
	...
	/*
	 * this method is responsible for test All Of It feature 
	 * 
	 * AllOfItPage class contains method to return webElements, going to use in test All Of It feature TESTING.
	 * AllOfItPageLocators contains locators of these webElement
	 * 
	 * Assertion :- To cross check that whether product is selected on not
	 */
	@Test(priority = 7)
	...
	/*
	 * this method is responsible for test Wish List feature. 
	 * 
	 *  WishListPage class contains method to return webElements, going to use in Christmas Gift Menu feature TESTING.
	 *  WishListPageLocators contains locators of these webElement
	 * 
	 *  Also handling pop up after clicking on wish list.
	 * 
	 * Assertion:- To cross check that whether product is added in wisLlist on not
	 */
	@Test(priority = 8)
	...
	public Object[][] dataSuplier() {
		...
		usernameAndPassword[2][0] = "rathorb87@gmail.com";
		usernameAndPassword[2][1] = "Bigsmall@123";
